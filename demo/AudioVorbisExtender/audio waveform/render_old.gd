class_name WaveformRenderer_old
extends WaveFormMesh

#note from current mae (about 5/26/26): WHAT THE FUCK WAS I DOING??
#i dont remember ANY of this really (thank u poor short term memory !)
#but i do remember being pissed off at it
#-- means thats current me commenting
...
#--man i was REALLY trying to stick to what the haxe version was trying to do
#thats probs why it sucks.. also i didnt know u could use _init() like how i do now
...
#--i clearly did not know how to actually use enums back then
...
func drawWaveform():
	...
	#--it seems this line is really expensive for whatever reason
	#i think it may be because waveformdata itself isnt ACTUALLY a godot PackedFloat32Array
	#so it freaks out whenever that gets called
...
#--yeah fuck it we rotate the WHOLE object when rotating
func orient():
	match orientation:
